...
/**
 * Entry point for integration tests that exercises {@link ThreadsController}
 * directly, bypassing {@code Main} (which requires a real
 * {@link java.io.Console} for console mode). The non-daemon executor threads
 * inside {@link ThreadsController} keep the JVM alive until
 * {@link ThreadsController#} calls {@code System.exit(0)}.
 */
